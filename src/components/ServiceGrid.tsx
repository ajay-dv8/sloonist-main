...
const SkeletonTwo = () => {
  return (
    <div>
      ...
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base mt-4 max-w-lg text-neutral-200">
        At Saloonist, we offer a comprehensive range of barbering &
        grooming services to cater for your unique style and preferences. We do, 
        haircuts & styling, beard trimming, hair coloring etc.
      </p>
    </div>
  );
};
const SkeletonThree = () => {
  return (
    <div>
      <p className="font-bold text-3xl md:text-4xl text-white">Exceptional hairdressing services</p>
      <p className="font-normal text-base text-white"></p>
      <p className="font-normal text-base mt-4 max-w-lg text-neutral-200">
        Experience professional hairdressing at Saloonist. We are 
        committed to helping look and feel your best. Our services include
  ...
  return (
    <div>
      ...
      <p className="font-normal text-base my-4 max-w-lg text-neutral-200">
        ...
        a moment of transformation, a testament to the magic our skilled stylist 
        create
      </p>
    </div>
  );
